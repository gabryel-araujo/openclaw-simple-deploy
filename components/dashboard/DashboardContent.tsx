  ...
  const recentChats = [
    {
      ...
      lastMessage:
        "O cliente perguntou sobre o prazo de entrega para o CEP 01000-000.",
      time: "2 min atrás",
    ...
    },
    {
      ...
      agentName: "Atendente Loja",
      lastMessage:
        "Confirmado o pagamento do pedido #1234. Iniciando processo de envio.",
      time: "15 min atrás",
      platform: "telegram" as const,
    },
    {
      ...
      lastMessage:
        "Cliente interessado no plano anual. Enviei a proposta comercial.",
      time: "1h atrás",
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-5">
            ...
            <p className="mt-2 text-sm text-indigo-200/70">
              Conecte seu WhatsApp Business para aumentar o engajamento em até
              40%.
            </p>
